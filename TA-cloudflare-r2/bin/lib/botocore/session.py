...
class Session:
    ...
    def _create_csm_monitor(self):
        # CSM (Client-Side Monitoring) disabled - UDP socket removed for
        # Splunk AppInspect compliance. CSM is an opt-in AWS feature that
        # this add-on never enables (requires AWS_CSM_ENABLED=true).
        return None
        return None
